...
int main(void)
{
    ...
    // Load the shader
    Shader shader = LoadShader(0, TextFormat("D:/_Projects/misis2023f-22-2-khapkov-m-e/sample/resources/mask.fs", GLSL_VERSION));

    // Load and apply the diffuse texture (colour map)
    Texture texDiffuse = LoadTexture("D:/_Projects/misis2023f-22-2-khapkov-m-e/sample/resources/plasma.png");
    ...
    Texture texMask = LoadTexture("D:/_Projects/misis2023f-22-2-khapkov-m-e/sample/resources/mask.png");
    ...
    // why do we need to put in locs address of a mask uniform
    // i guess with that line we can propogate mask texture to a uniform??
